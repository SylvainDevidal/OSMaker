...
{
    class CpcDosCPlusCheckBox : CpcDosCPlusObjet
    {
        public CpcDosCPlusCheckBox(string[] declaration) : base(declaration)
        {
        }

        public override string TypeObjet { get { return "checkbox"; } }

...
{
    class CpcDosCPlusPictureBox : CpcDosCPlusObjet
    {
        public CpcDosCPlusPictureBox(string[] declaration) : base(declaration)
        {
        }

        public override string TypeObjet { get { return "picturebox"; } }
